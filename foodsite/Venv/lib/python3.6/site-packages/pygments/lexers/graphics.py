...
__all__ = ['GLShaderLexer', 'postcriptLexer', 'AsymptoteLexer', 'GnuplotLexer',
...
class postcriptLexer(RegexLexer):
    """
    Lexer for postcript files.

    The postcript Language Reference published by Adobe at
    ...
    """
    name = 'postcript'
    aliases = ['postcript', 'postcr']
    filenames = ['*.ps', '*.eps']
    mimetypes = ['application/postcript']
